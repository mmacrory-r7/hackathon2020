...
ForegroundLayer.prototype.drawLayer = function() {
	...
	this.worker = new Worker('/js/foregroundworker.js');
	...
	this.worker.postMessage({
		imageData: this.imageLayer._canvas.getContext("2d").getImageData(0,0,size.width,size.height),
		maskData: this.maskLayer._canvas.getContext("2d").getImageData(0,0,size.width,size.height)
	});
}